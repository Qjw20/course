...
if __name__ == "__main__":
    ...
    files_pre_dir = "/root/autodl-tmp/data/CCPD2019/crops2017/"
   ...
   # sub_names = ['ccpd_base_1250', 'ccpd_blur_1250', 'ccpd_challenge_1250', 'ccpd_db_1250', 'ccpd_fn_1250', 'ccpd_rotate_1250', 'ccpd_tilt_1250', 'ccpd_weather_1250']
    ...
    for name in sub_names:
        images_dir = files_pre_dir + name + "/images"
        new_dir ="/root/autodl-tmp/data/CCPD2019/recognize2017/" +  name
        ...
        for i in range(n):
            ...
            original_image_path = "/root/autodl-tmp/data/CCPD2019/" + name + "/val/" + os.listdir(images_dir)[i]
            txt_name = os.listdir(images_dir)[i][:-4] + ".txt"
            box_path = images_dir.replace('images', 'labels/') + txt_name
